...
public class SlotType implements ConfigurationSerializable {
    ...
    public Map<String, Object> serialize() {
        ...
        map.put("cost_usage", this.cost);
        map.put("cost_create", this.createCost);
    ...
    public static SlotType deserialize(Map<String, Object> map) {
        ...
        t.setCost(NumberConversions.toDouble(map.get("cost_usage")));
        t.setCreateCost(NumberConversions.toDouble(map.get("cost_create")));
